...
### Foodage (Flutter | GetX | MVC)
- Developed a food discovery platform with API-driven content  
- Published on Google Play Store and Apple App Store  

### Pickleball Manager (Flutter)
- Built a sports management application with scheduling and tracking features  

### Life Defender Alert (SwiftUI | MVVM)
- Developed a real-time safety alert system with responsive UI  

### Ishana Dance (SwiftUI)
- Delivered a feature-rich iOS application with scalable architecture  
...
## CORE COMPETENCIES
Mobile Architecture • Performance Optimization • API Integration • Scalable Systems • Cross-Platform Development • UI/UX Implementation  
